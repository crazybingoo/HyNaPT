function connection_coc = compute_hyperedge_weight(datanew)
    ...
    if exist('measure_COC', 'file') ~= 2
        error('HyNaPT:MissingCOCDependency', ...
            ['measure_COC is required for manuscript-compatible COC ' ...
             'weights but is not part of the historical public upload.']);
    end
